    ...
    <div class="hidden md:flex md:w-1/2 bg-gradient-to-br from-violet-600 via-violet-800 to-purple-900 p-12 relative overflow-hidden">
        <div class="relative z-10 flex flex-col justify-center">
            ...
            <p class="text-violet-200 text-xl mb-8 leading-relaxed">
                Ən yaxşı məhsullar, ən sərfəli qiymətlər və premium xidmət - hamısı bir yerdə.
            </p>
            <div class="flex space-x-6">
                <div class="flex items-center space-x-2">
                    ...
                    <span class="text-violet-200">Təhlükəsiz Ödəniş</span>
                </div>
                <div class="flex items-center space-x-2">
                    <div class="p-2 bg-white/10 rounded-lg">
                        <svg class="w-6 h-6 text-violet-200" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <span class="text-violet-200">Sürətli Çatdırılma</span>
                </div>
            </div>
        </div>
        <!-- Arkaplan Deseni -->
        ...
        <div class="w-full max-w-md space-y-8">
            <div class="text-center">
                ...
                <p class="mt-2 text-sm text-gray-600">
                    və ya
                    <a href="{{ route('login') }}" class="font-medium text-violet-600 hover:text-violet-500 transition-colors duration-200">
            ...
            <div class="mt-6">
                ...
                <div class="mt-6 grid grid-cols-2 gap-3">
                    <div>
                        <a href="#" class="w-full inline-flex justify-center py-2 px-4 border border-gray-300 rounded-lg shadow-sm bg-white text-sm font-medium text-gray-500 hover:bg-gray-50 transition-colors duration-200">
